        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Our Story</h2>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-3 md:mb-4">
                Find Store was founded with a simple mission: to make quality products accessible to everyone, 
                everywhere. We believe that shopping should be easy, enjoyable, and trustworthy.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Since our launch, we've been committed to providing our customers with a curated selection 
            ...
            <div className="mb-8 md:mb-12">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-3 md:mb-4">
                To connect customers with quality products while supporting sellers and creating a 
                sustainable marketplace ecosystem. We're dedicated to:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                <li>Providing exceptional customer service</li>
                <li>Ensuring product quality and authenticity</li>
                <li>Supporting small businesses and independent sellers</li>
                <li>Creating a safe and secure shopping environment</li>
                <li>Offering competitive prices and fast delivery</li>
              </ul>
            </div>

            <div className="mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Why Choose Us</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="p-6 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-gray-600">
                    We work with trusted shipping partners to get your orders to you quickly and safely.
                  </p>
                </div>
            ...
            <div className="mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Contact Us</h2>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-3 md:mb-4">
