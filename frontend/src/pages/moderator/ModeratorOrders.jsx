                      ...
                      {order.assignedDeliveryMan ? (
                        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                <p className="font-semibold text-gray-900">{order.assignedDeliveryMan.name || 'N/A'}</p>
                                {order.assignedDeliveryMan.email && (
                                  <p className="text-sm text-gray-600">{order.assignedDeliveryMan.email}</p>
                                )}
                              </div>
                            </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-gray-500 italic">No delivery man assigned yet</p>
                          </div>
                        </div>
                      )}
