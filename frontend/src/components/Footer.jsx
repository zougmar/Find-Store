  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2">
            ...
            <p className="text-gray-600 text-xs md:text-sm mb-4 max-w-md">
              Your trusted marketplace for quality products. Shop with confidence and enjoy fast delivery.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 mt-6 md:mt-8 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs md:text-sm text-gray-600 text-center md:text-left">
            &copy; {new Date().getFullYear()} Find Store. All rights reserved.
          </p>
